...
export class LoginComponent implements OnInit {
  ...
  imgLogo1 = 'assets/img/logo/penang-logo.png'
  ...
  login() {
    ...
    else if (this.loginForm.value.username == 'tc') {
      this.authService.userRole = 2
      localStorage.setItem('userRole', '2');
      this.navigatePage('dashboard-training-coordinator')
    }
  }
  ...
  navigatePage(path: String) {
    ...
    else if (path == 'dashboard-training-coordinator') {
      return this.router.navigate(['/user/dashboard'])
    }
  }
